...
The total energy of the system can be extracted using the internal LAMMPS variable etotal, see the [second input](./a-simulation-with-no-thermostat/input.b.lammps).
